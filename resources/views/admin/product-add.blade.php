                ...
                <div class="wg-box">
                    ...
                    <fieldset>
                        ...
                        <div class="upload-image mb-16">
                            <div id="galUpload" class="flex gap10">
                    ...
                    <script>
                        // simple gallery preview for multiple files
                        (function(){
                            const $gFile = document.getElementById('gFile');
                            const $galUpload = document.getElementById('galUpload');
                            if (!$gFile || !$galUpload) return;
                            ...
                            $gFile.addEventListener('change', function () {
                                ...
                                files.forEach(function(file){
                                    ...
                                    wrapper.className = 'item gitems';
                                    const img = document.createElement('img');
                                    img.src = url;
                                    img.alt = file.name;
                                    wrapper.appendChild(img);
                                    $galUpload.prepend(wrapper);
                                });
                            });
                        })();
                    </script>
